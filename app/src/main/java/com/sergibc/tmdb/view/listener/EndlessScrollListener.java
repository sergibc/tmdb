package com.sergibc.tmdb.view.listener;
...
public abstract class EndlessScrollListener extends RecyclerView.OnScrollListener {
    ...
    private int currentPage = MovieListPresenter.DEFAULT_FIRST_PAGE;
    ...
    private int startingPageIndex = MovieListPresenter.DEFAULT_FIRST_PAGE;
