...
/**
 * CLASS 100% CLONED FROM https://github.com/AndroidDeveloperLB/AutoFitTextView
 * <p>
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSPace) {
                ...
                if (singleLine) {
                    ...
                    final StaticLayout layout = new StaticLayout(text, _paint, _widthLimit, Alignment.ALIGN_NORMAL, _spacingMult,
                            _spacingAdd, true);
